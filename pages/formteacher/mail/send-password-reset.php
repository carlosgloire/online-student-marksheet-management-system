...
if(isset($_POST['send'])){
 if(isset($_POST['email'])){
    ...
    $query = $mysqli->prepare("SELECT * FROM form_tutors WHERE email = ?");
        ...
        if ($mysqli->affected_rows) {
            ...
            <body>
                <div class="container">
                    ...
                    <p style="text-align: center;"><a class="button" href="http://localhost/armel-dashboard/pages/formteacher/mail/reset-password.php?token=$token">Reset Password</a></p>
